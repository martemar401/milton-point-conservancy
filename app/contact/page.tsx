  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        <section className="contact-map-section"><div className="contact-map-heading"><p className="section-kicker">Find the properties</p><h2>Three places along Milton Road.</h2></div><MapSection /></section>
      </main>
      <SiteFooter />
    </>
  );
